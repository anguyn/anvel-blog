...
export interface DictionaryStructure {
  ...
  settings: {
    ...
    commentReply: string;
    commentReplyDescription: string;
    newFollower: string;
    newFollowerDescription: string;
    mentionInComment: string;
    mentionInCommentDescription: string;
    ...
    notificationSummaryDescription: string;
    instantly: string;
    daily: string;
    weekly: string;
    never: string;
    ...
    disableTwoFactorPasswordDesc: string;
    disableTwoFactorOtpDesc: string;
    ...
    trustedDevicesDesc: string;
    securityKeys: string;
    securityKeysDesc: string;
    comingSoon: string;
    developmentNote: string;
    securityReLoginMessage: string;
    redirectingLogin: string | ((params: { second: number }) => string);
    disable2FA: string;
    changeEmail: string;
  };
  posts: {
